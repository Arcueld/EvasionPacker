...
//    0x41, 0x55,                                          // push r13          //��ջ
//    0x41, 0x56,                                          // push r14          //��ջ
//    0x49, 0x89, 0xD6,                                    // mov r14, rdx      //�ڶ������� ��syscallָ���ַ
//    0x49, 0x89, 0xCD,                                    // mov r13, rcx      //��һ������ ��SSN
//    0x4C, 0x89, 0xC1,                                    // mov rcx, r8       //�����ĵ�1������
//    0x4C, 0x89, 0xCA,                                    // mov rdx, r9       //�����ĵ�2������
//    0x4C, 0x8B, 0x44, 0x24, 0x38,                        // mov r8, [rsp+38h]   //�����ĵ�3������
//    0x4C, 0x8B, 0x4C, 0x24, 0x40,                        // mov r9, [rsp+40h]   //�����ĵ�4������
//    0x48, 0x83, 0xC4, 0x28,                              // add rsp, 28h        //ջ��ָ�������ƶ� ��ջƽ��
//    0x4C, 0x8D, 0x1D, 0x0C, 0x00, 0x00, 0x00,            // lea r11, [rip+0x0C] ----
//    0x41, 0xFF, 0xD3,                                    // call r11               |  //����
//    0x48, 0x83, 0xEC, 0x28,                              // sub rsp, 28h           |  //ջ��ָ�������ƶ� ��ջƽ��
//    0x41, 0x5E,                                          // pop r14                |  //
//    0x41, 0x5D,                                          // pop r13                |  //��ԭ������
//    0xC3,                                                // ret                    |
//                                                                                   |
...
//    0x49, 0x89, 0xCA,                                    // mov r10, rcx              //
//    0x41, 0xFF, 0xE6                                     // jmp r14                   //jmp��syscallָ�����x64����ϵͳ����
//};
	...
	for (size_t i = 0; i < runtimefunctable[i].BeginAddress; i++)
	{
		for (size_t j = 0; j < export_dir->NumberOfFunctions; j++)
		{
			if (functions_table[names_ordinals_table[j]] == runtimefunctable[i].BeginAddress) {
				...
				//std::cout << "#define "
				//    << function_name << "_Hashed 0x"
				//    << std::hex << std::setw(8) << std::setfill('0') << HASH(function_name)
				//    << std::endl;                //insert to map
